...
impl TaskNode {
    ...
    /// Checks if the file content on disk matches the canonical rendered format.
    ///
    /// # Errors
    ///
    /// Returns an error if reading the file from disk or generating the canonical content fails.
